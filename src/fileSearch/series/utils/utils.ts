...
import { getEpisodes, getSeasons } from "@/db/get/getData";
import { addEpisode, addSeason } from "@/db/post/postData";
...
export async function resolveEpisodeMetadata(
  ...
  const seasonEpisode: [number, number?] = Utils.extractEpisodeSeason(fullName);
