      ...
      <View className="relative w-screen h-screen bg-black">
        ...
        >
          <View className="justify-center items-center">
            ...
            />
            <Subtitle className="text-center pt-3 pb-0">{currentSong.title}</Subtitle>
        ...
        {/* Controls */}
        {isShown && (
          <SpatialNavigationView direction="vertical" style={styles.controlsContainer}>
            {/* Progress Slider */}
            ...
            >
              <Button onPress={toggleShowLyrics} icon={MessageSquareQuote} />
