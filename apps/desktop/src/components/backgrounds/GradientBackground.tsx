...
const getImageColorsSourceKey = (params?: {
	url?: string;
	localPath?: string;
}): string => {
...
const GradientBackground = ({
	...
	const imageColorsParams = useMemo(
		() => buildImageColorsParams(imageSrc),
		[imageSrc],
	);
	...
	const imageColorsCss = normalizeGradientCss(
		imageColorsData?.css ?? imageColorsData?.data?.css,
	);
	...
	useEffect(() => {
		...
		const resolvedGradient =
			imageColorsCss || gradientCacheRef.current[imageSourceKey];
