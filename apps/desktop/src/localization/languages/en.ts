export const en = {
  translation: {
    ...
    exclusiveAudio: 'Exclusive audio',
    exclusiveAudioDesc: 'Bypass the system audio mixer, ensuring the output device receives unprocessed audio',
    ...
    qualityInterpolation: 'Interpolation',
    volumeOff: 'Off',
    volumeLow: 'Low',
    volumeMedium: 'Medium',
    volumeHigh: 'High',
