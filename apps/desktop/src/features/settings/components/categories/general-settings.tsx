...
const THEME_MUSIC_VALUES: ThemeMusicVolume[] = [
	"off",
	"low",
	"medium",
	"high",
...
const SCREENSAVER_VALUES: ScreensaverTimeout[] = [
	"off",
	"1m",
	"5m",
	"10m",
	...
	return (
		<div className="flex flex-col gap-1">
			...
			<SettingSelect
				...
				onChange={(v) =>
					updateSetting("themeMusicVolume", v as ThemeMusicVolume)
				}
			/>
			<SettingSelect
			...
			<SettingSlider
				...
				min={0}
				max={15}
				displayValue={t("autoplayCountdownUnit", {
					value: settings.autoplayCountdown,
				})}
