...
function getSelectedInfoItems(
	...
	return [episodeCode, releaseDate, remainingMinutes].filter(
		Boolean,
	) as string[];
}
...
function renderContinueWatchingContent({
	...
	setSelectedElement: React.Dispatch<
		React.SetStateAction<ContinueWatchingVideoDTO | null>
	>;
	t: (key: string) => string;
}) {
...
function Home() {
	...
	const [selectedElement, setSelectedElement] =
		useState<ContinueWatchingVideoDTO | null>(null);
	...
	const { data: continueWatching, isLoading } = useGetContinueWatching<
