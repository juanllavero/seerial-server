...
function Controls({
	...
	const notifyPanelChange = useCallback(() => {
		const anyOpen =
			openPanelsRef.current.tracks || openPanelsRef.current.settings;
	...
	// Get playback config
	const { data: playBackInfo } = useGetVideoPlaybackInfo<PlayBackInfo>(
		video.id,
		{
			...
			>
				<TimelineSlider
					...
					keyboardShortcutEnabled={
						controlsMode === "compact" || isTimelineFocused
					}
