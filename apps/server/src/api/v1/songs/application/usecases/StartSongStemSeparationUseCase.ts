...
import type { AudioProcessingServicePort, StemSeparationJob } from '../ports/AudioProcessingServicePort';
...
export class StartSongStemSeparationUseCase {
    ...
    async execute(songId: string): Promise<StemSeparationJob> {
        ...
        return this.audioProcessingService.queueStemSeparation(songId, song.fileSrc);
    }
}