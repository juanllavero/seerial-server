...
export interface WatchListRepositoryPort {
  ...
  getContinueWatchingVideos(userId: string): Promise<ContinueWatchingVideoDTO[]>;
  ...
  clearContinueWatching(userId: string, seriesId?: string, movieId?: string): Promise<boolean>;
}
