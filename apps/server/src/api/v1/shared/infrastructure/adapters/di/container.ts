...
export const useCases = {
	...
	addVideoToContinueWatching: () =>
		new AddContinueWatchingVideoUseCase(watchListRepo),
	removeVideoFromContinueWatching: () =>
		new RemoveContinueWatchingVideoUseCase(watchListRepo),
	removeAllFromContinueWatching: () =>
		new ClearContinueWatchingUseCase(watchListRepo),
	getContinueWatchingVideos: () =>
		new GetContinueWatchingVideosUseCase(watchListRepo),
	...
	getCurrentlyWatchingEpisode: () =>
		new GetCurrentWatchListEpisodeUseCase(watchListRepo),
	getCurrentlyWatchingVideo: () =>
		new GetCurrentWatchListVideoUseCase(watchListRepo),
};
