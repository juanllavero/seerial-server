...
beforeEach(async () => {
    ...
    mockContainer.useCases.updateSong.mockReturnValue({ execute: jest.fn().mockResolvedValue(mockSong) });
    mockContainer.useCases.deleteSong.mockReturnValue({ execute: jest.fn().mockResolvedValue(undefined) });
    mockContainer.useCases.getSongById.mockReturnValue({ execute: jest.fn().mockResolvedValue(mockSong) });
});
