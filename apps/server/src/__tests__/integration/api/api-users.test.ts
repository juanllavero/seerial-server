...
beforeAll(async () => {
	...
	mockContainer.useCases.createUser.mockReturnValue(
		new CreateUserUseCase(repo),
	);
	mockContainer.useCases.authenticateUser.mockReturnValue(
		new AuthenticateUserUseCase(repo),
	);
	mockContainer.useCases.getAllUsers.mockReturnValue(
		new GetAllUsersUseCase(repo),
	);
	mockContainer.useCases.updateUser.mockReturnValue(
		new UpdateUserUseCase(repo),
	);
	mockContainer.useCases.deleteUser.mockReturnValue(
