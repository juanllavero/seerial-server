...
describe('GenericRepositoryHelper', () => {
  ...
  it('createRelationship returns the existing relation when found', async () => {
    ...
    await expect(
      helper.createRelationship(relationModel, { name: 'Existing' } as Partial<TestEntity>),
  ...
  it('createRelationship wraps persistence errors', async () => {
    ...
    await expect(
      helper.createRelationship(relationModel, { name: 'Broken' } as Partial<TestEntity>),
  ...
  it('deleteRelationship deletes relation rows and wraps errors', async () => {
    ...
    await expect(
      helper.deleteRelationship(relationModel, { id: 'rel-1' } as Partial<TestEntity>),
