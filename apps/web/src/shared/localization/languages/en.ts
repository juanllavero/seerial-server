export const en = {
  translation: {
    ...
    successfulLinkMessage: 'You can now use your TV app. Redirecting to home...',
    friends: 'Friends',
    servers: 'Servers',
    ...
    shareServersButton: 'Share servers',
    addFriendButton: 'Add friend',
    searchUser: 'Search user',
    noOwnServers: 'You have no own servers',
    noServers: 'You have no associated servers',
    ...
    serverErrorMessage: 'Seerial Server is not running on localhost (http://localhost:34200).',
    ...
    collectionNameExists: 'A collection with that name already exists',
    createCollectionError: 'Error creating collection',
    collectionCreated: 'Collection created',
    noCollections: 'No collections found',
    itemAdded: 'Added to collection',
    itemRemoved: 'Removed from collection',
    selectLibrary: 'Select library',
    addItemsToCollection: 'Add items',
