...
import ExpandedMobileMusicControls from './controls/expanded-mobile-music-controls';
import MinimizedBar from './controls/minimized-bar';
...
const MobileMusicPlayer = () => {
  ...
  const handleTouchMove = (e: TouchEvent) => {
    ...
    // Stop dragging if touch goes outside the viewport.
    if (touch.clientY < 0 || touch.clientY > window.innerHeight + 50) {
      handleTouchEnd();
      return;
    }

    // Force end when drag distance exceeds the allowed limit.
