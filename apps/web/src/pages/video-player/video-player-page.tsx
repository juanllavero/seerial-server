...
import {
  VideoPlayerControls as Controls,
...
type TimelineEvent = MouseEvent | ReactMouseEvent<HTMLDivElement>;
...
function VideoPlayerPage() {
  ...
  //#region Timeline
  const handleTimelineUpdate = (e: TimelineEvent) => {
    const videoPlayer = videoRef.current;
    if (!videoPlayer || !timelineRef.current) return;
  ...
  const toggleScrubbing = (e: TimelineEvent) => {
