...
export const API = {
    ...
    collections: {
        ...
        addMovie: (id: string, movieId: string) => `/collections/${id}/movies/${movieId}`,
        addSeries: (id: string, seriesId: string) => `/collections/${id}/series/${seriesId}`,
        addAlbum: (id: string, albumId: string) => `/collections/${id}/albums/${albumId}`,
        removeMovie: (id: string, movieId: string) => `/collections/${id}/movies/${movieId}`,
        removeSeries: (id: string, seriesId: string) => `/collections/${id}/series/${seriesId}`,
        removeAlbum: (id: string, albumId: string) => `/collections/${id}/albums/${albumId}`,
    },
    artists: {
        create: '/artists',
